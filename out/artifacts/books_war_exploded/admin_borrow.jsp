...
<body class="bootstrap-admin-with-small-navbar">
					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
									...
									<form class="form-horizontal" action="/JournalServlet"
									  method="post">
						...
						<table id="data_list" class="table table-hover table-bordered"
							...
							<tbody>
								...
								<td><button type="button" class="btn btn-warning btn-xs"
										onclick="haibook(<%=bean.getHid()%>,<%=bean.getCard()%>,'<%=bean.getEndtime()%> 00:00:00',<%=bean.getBid()%>,<%=bean.getAid()%>)">归还</button>
    ...
    function haibook(hid,card,endTime,bid,aid) {
    	con=confirm("是否归还?");
    	if(con==true){
    		//location.href = "/borrowServlet?tip=2&show=2&hid="+hid;
    		location.href = "/borrowServlet?tip=2&show=2&hid="+hid+"&card="+card+"&endTime="+endTime+"&bid="+bid+"&aid="+aid;
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="endtime" class="col-sm-3 control-label">截至归还时间</label>
							<div class="col-sm-7">
