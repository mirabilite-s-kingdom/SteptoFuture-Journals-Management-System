			...
			<div class="col-md-10">
					...
					<div class="col-md-6">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="text-muted bootstrap-admin-box-title">期刊管理</div>
							</div>
							<div class="bootstrap-admin-panel-content">
								<ul>
									<li>根据期刊名称、作者、分类查询期刊基本信息</li>
									<li>添加、修改或删除期刊信息</li>
								</ul>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="text-muted bootstrap-admin-box-title">期刊分类管理</div>
							</div>
							<div class="bootstrap-admin-panel-content">
								<ul>
									<li>查看期刊分类信息，显示分类ID</li>
									<li>添加、修改或删除期刊分类</li>
								</ul>
							</div>
						</div>
